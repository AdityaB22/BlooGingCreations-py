...
from win32api import WriteProfileSection
...
if __name__ == '__main__':
    ...
    window.title("Integratin With Ludo")
    window.iconbitmap("D:\python projects.py\LUDO AI")
    block_six_side = ImageTk.PhotoImage(Image.open("ludo face 6.png").resize((33, 33), Image.ANTIALIAS))
    block_five_side = ImageTk.PhotoImage(Image.open("ludo face 5.png").resize((33, 33), Image.ANTIALIAS))
    block_four_side = ImageTk.PhotoImage(Image.open("ludo face 4.png").resize((33, 33), Image.ANTIALIAS))
    block_three_side = ImageTk.PhotoImage(Image.open("ludo face 3.png").resize((33, 33), Image.ANTIALIAS))
    block_two_side = ImageTk.PhotoImage(Image.open("ludo face 2.png").resize((33, 33), Image.ANTIALIAS))
    block_one_side = ImageTk.PhotoImage(Image.open("ludo face 1.png").resize((33, 33), Image.ANTIALIAS))
